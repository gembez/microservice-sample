...
public class ApiGatewayController {
    ...
    private static final String app_name = "Zuul Service";
    ...
    */
    ...
    public String openCar(@RequestParam(value="sessionID", required=false, defaultValue="null") String sessionID) {
    ...
    @RequestMapping("/getCars")
        public String showCars(@RequestParam(value="sessionID", required=false, defaultValue="null") String sessionID) {
        tracer.addTag("sessionID", sessionID);
        String msg = app_name;
    ...
    public String reserveCar(@RequestParam(value="sessionID", required=false, defaultValue="null") String sessionID) {
        tracer.addTag("sessionID", sessionID);
        String msg = app_name;
    ...
    public String bookCar(@RequestParam(value="sessionID", required=false, defaultValue="null") String sessionID) {
        tracer.addTag("sessionID", sessionID);
        String msg = app_name;
    ...
    public String endRental(@RequestParam(value="sessionID", required=false, defaultValue="null") String sessionID) throws InterruptedException {
        tracer.addTag("sessionID", sessionID);
        String msg = app_name;
        Thread.sleep(2200);
    ...
    public String showBalance(@RequestParam(value="sessionID", required=false, defaultValue="null") String sessionID) {
        tracer.addTag("sessionID", sessionID);
        String msg = app_name;
    ...
    public String bookPackage(@RequestParam(value="sessionID", required=false, defaultValue="null") String sessionID) {
        tracer.addTag("sessionID", sessionID);
        String msg = app_name;
    ...
    public String findRoute(@RequestParam(value="sessionID", required=false, defaultValue="null") String sessionID) {
        tracer.addTag("sessionID", sessionID);
        String msg = app_name;
    ...
    public String reportIssue(@RequestParam(value="sessionID", required=false, defaultValue="null") String sessionID) {
        tracer.addTag("sessionID", sessionID);
        String msg = app_name;
